...
char humidity2Stream[] = "humidity2";
char temp2Stream[] = "temp2";
...
XivelyDatastream datastreams[] = {
  ...
  XivelyDatastream(humidity2Stream, strlen(humidity2Stream), DATASTREAM_FLOAT),
  XivelyDatastream(temp2Stream, strlen(temp2Stream), DATASTREAM_FLOAT),
...
XivelyFeed feed(FEED_ID, datastreams, 7);
...
void setup(){
 ...
 void loop(){
  ...
  errorCode2 = myOtherDHT22.readData();
  temperature2 = myOtherDHT22.getTemperatureC();
  humidity2 = myOtherDHT22.getHumidity();
  tempF2 = (temperature2*1.8)+32;
  ...
  datastreams[2].setFloat(humidity2);
  datastreams[3].setFloat(tempF2);
  datastreams[4].setFloat(main1);
  datastreams[5].setFloat(main2);
  datastreams[6].setFloat(comb);
